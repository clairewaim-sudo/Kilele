...
export function Hero({ eyebrow, title, tagline, description, secondaryCta }: HeroProps) {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-forest to-forest-deep px-4 py-16 text-white sm:px-6 sm:py-24">
      <MountainPattern className="text-white opacity-[0.08]" />
